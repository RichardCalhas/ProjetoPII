<?php
	switch($_REQUEST["acao"]){
		...
		break;*/
		case "desativarPerma":
			$sql = "UPDATE servico SET status='Desativado' WHERE id_Servico=".$_REQUEST['id_Servico'];
...
<p>
	...
	<button type="button" onclick="location.href='?page=Listar-Servicos-Desativados';" class="btn btn-success">Listar Serviços Desativados</button>
</p>
